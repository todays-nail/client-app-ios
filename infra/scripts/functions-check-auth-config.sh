...
expected_mode_for() {
  case "$1" in
    feed-detail|feed-like|feed-list|nail-gen-delete|nail-gen-list|nail-gen-refine-request|nail-gen-request|nail-gen-status|nail-gen-upload-url|profile-style-insight|quote-request-create|regions-list|reservation-create|reservation-list|reservation-slots|shop-detail|shop-recommend|shop-search|users-delete|users-me)
      echo "app_access_jwt"
      ;;
